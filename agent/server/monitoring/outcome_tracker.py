...
class OutcomeTracker:
    ...
    def __init__(self, log_dir: Path | str = "logs/outcomes") -> None:
    ...
    async def update_outcome(
        self, decision_id: str, status: ExecutionStatus, **kwargs: object
    ...
    @staticmethod
    def _apply_update(outcome: DecisionOutcome, key: str, value: object) -> None:
